...
//
// Implementation of part 4a - looking up and down
//
...
/* Short description
   -----------------
   This implementation is the follow up of implementation part 3b (NOTE: part 3c was a side step, and not a shackle in the progressive
   chain of implementations. See the description of part 3b as well (and check on the differences between that cpp file and this one).
   ...
   The core of portal rendering was implemented in part 3b. This part and the next are fancying up that code with various concepts.
   This part implements mouse aiming and the ability to look up and down in the scene.
