...
//
// Implementation of part 2b - player movement
//
...
/* Short description
   -----------------
   This implementation is the follow up of implementation part 2a. See the description of that implementation as well (and check on
   ...
   This part handles the player horizontal movement - forward, back, rotation and strafing. There is no
   collision detection yet.
   A number of convenience functions are created to help determine the geometry of crossing a sector boundary. 
   A new method MovePlayer() is created, and all the user interaction is put into OnUserUpdate()
